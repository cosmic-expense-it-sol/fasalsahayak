...
<div class="row">
	<div class="box box-solid">
		<div class="box-header with-border">
			<h3 class="box-title"><b>Become a Smart Bharat-Vaasi</b></h3>
		</div>
		<div class="box-body">
			<p>Get free updates on the latest Government Schemes and Various ohter workshops on Agricultural Activity.</p>
