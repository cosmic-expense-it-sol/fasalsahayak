                                        ...
                                        try {
                                            ...
                                            foreach ($stmt as $row) {
                                                ...
                                                if ($row['status'] == 0) {
                                                    ...
                                                    $btn3 = "
                                                    <a class='btn btn-warning btn-sm btn-flat' href='dealer_actions/verification.php?action=debarr&id=" . $row['id'] . "'><i class='fa fa-scissors'></i> Debarr</a>
                                                    ";
                                                ...
                                                $status = '<span class="label label-danger">Debarred</span>';
                                                $btn = "
                                                <a class='btn btn-success btn-sm btn-flat' href='dealer_actions/verification.php?action=verify&id=" . $row['id'] . "'><i class='fa fa-edit'></i> Verify</a>
                                                ";
                                            } else {
